...
function DoctorData() {
  ...
  const handleSubmit = (userId) => {
    ...
    if (validateForm(updatedDetails)) {
      ...
      axios
        .put(`${updateDoctorDetails}${userId}`, updatedDetails, authConfig)
        .then((response) => {
  ...
  useEffect(() => {
    const getDoctorInfos = async () => {
      ...
      try {
        const response = await axios.get(`${getDoctorInfo}${id}`, authConfig);
              ...
              <Card>
                <Card.Body>
                  ...
                  <ListGroup variant="flush">
                    ...
                    <ListGroup.Item>
                      <strong>My Name:</strong> {selectedUser.doctorName}
                    </ListGroup.Item>
                    <ListGroup.Item>
                      <strong>My Email:</strong> {selectedUser.email}
                    </ListGroup.Item>
                    <ListGroup.Item>
                      <strong>Speciality:</strong> {selectedUser.specialty}
                    </ListGroup.Item>
                    <ListGroup.Item>
                      <strong>My Password:</strong> {selectedUser.password}
                    </ListGroup.Item>
                    <ListGroup.Item>
              ...
              <div>
                ...
                <div className="form-outline mb-4">
                  <label className="form-label" htmlFor="doctorName">
                    My Name: {selectedUser.doctorName}
                  </label>
                  <input
                    type="text"
                    id="doctorName"
                ...
                <div className="form-outline mb-4">
                  <label className="form-label" htmlFor="specialty">
                    My Specialty: {selectedUser.specialty}
                  </label>
                  <input
                    type="text"
                    id="specialty"
                    className={`form-control form-control-lg ${
                      formErrors.specialty ? "is-invalid" : ""
                    }`}
                    value={specialty}
